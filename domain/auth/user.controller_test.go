...
func TestUserCRUD(t *testing.T) {
	...
	t.Run("POST /users (Admin 201)", func(t *testing.T) {
		...
		var respDTO auth.UserResponseDTO
	...
	t.Run("POST /users (User 403)", func(t *testing.T) {
		dto := auth.UserCreateDTO{Username: "failuser", Email: "fail@user.com", Password: "password123"}
	...
	t.Run("GET /users (Admin 200)", func(t *testing.T) {
		...
		var listResp pagination.Response[auth.UserResponseDTO]
